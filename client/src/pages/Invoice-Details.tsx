        ...
        <Card className="border-2 border-amber-200/50 shadow-2xl rounded-2xl overflow-hidden bg-gradient-to-br from-white via-amber-50/10 to-white">
          <CardContent className="p-0">
            <div ref={invoiceRef} className="p-8 md:p-12 bg-white text-slate-900">
              ...
              {/* Client Info */}
              <div className="mb-12 p-6 bg-gradient-to-br from-amber-50/50 to-white rounded-xl border-2 border-amber-200/50 shadow-inner">
              ...
              {/* Invoice Details */}
              <div className="grid grid-cols-2 gap-6 mb-12 p-6 bg-gradient-to-br from-amber-50/50 to-white rounded-xl border-2 border-amber-200/50">
                <div>
                  <div className="text-xs font-bold uppercase text-amber-700 mb-1 tracking-wider">Invoice Date</div>
                  <div className="text-slate-900 font-semibold">
                    {displayInvoice.createdAt ? format(new Date(displayInvoice.createdAt), "MMM dd, yyyy") : 'N/A'}
                  </div>
                </div>
                <div>
                  <div className="text-xs font-bold uppercase text-amber-700 mb-1 tracking-wider">Due Date</div>
                  <div className="text-slate-900 font-semibold">
                    {displayInvoice.dueDate ? format(new Date(displayInvoice.dueDate), "MMM dd, yyyy") : 'N/A'}
                  </div>
                </div>
